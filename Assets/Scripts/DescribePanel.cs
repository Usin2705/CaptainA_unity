...
public class DescribePanel : MonoBehaviour
{
    ...
    [SerializeField]
    GPTGradingPanel gptGradingPanel;
    ...
    void OnEnable()
    {
        ...
        if (
            taskType == TaskType.A
            || taskType == TaskType.A2
            || taskType == TaskType.C
            || taskType == TaskType.C2
        )
        {
            transcriptGO.GetComponent<TMPro.TextMeshProUGUI>().text =
                "Please describe the room and objects (colours, positions) in the picture above. You have 45 seconds to speak.";
            recordingTime = Const.MAX_REC_TIME_A;
        }
        else if (taskType == TaskType.B)
        {
            transcriptGO.GetComponent<TMPro.TextMeshProUGUI>().text =
                "Situation: You met with your friends at a café yesterday evening. At home, you notice your hoodie is missing. You call the café (max 30sec): Introduce yourself. Politely state your matter. Describe the hoodie (see the picture above). <b>Note: Do not disclose your real name or personal matters.</b> You can use the name Maija/Matti Meikäläinen.";
    ...
    */
    {
        ...
        switch (taskType)
        {
            ...
            case TaskType.A2:
                ...
                imageComponent.sprite = Resources.Load<Sprite>(
                    "GenAI/" + "taskA_" + taskNumber.ToString()
                );
                break;
            ...
            case TaskType.B:
                ...
                // The image is in the Resources folder
                imageComponent.sprite = Resources.Load<Sprite>(
                    "GenAI/" + "taskB_" + taskNumber.ToString()
                );
                taskText =
                    "Situation: You met with your friends at a café yesterday evening. At home, you notice your hoodie is missing. You call the café (max 30sec): Introduce yourself. Politely state your matter. Describe the hoodie (see the picture above). <b>Note: Do not disclose your real name or personal matters.</b> You can use the name Maija/Matti Meikäläinen.";
                if (taskNumber > 0)
                    taskText =
                        "Situation: You met with your friends at a café yesterday evening. At home, you notice your jacket is missing. You call the café (max 30sec): Introduce yourself. Politely state your matter. Describe the jacket (see the picture above). <b>Note: Do not disclose your real name or personal matters.</b> You can use the name Maija/Matti Meikäläinen.";
    ...
    */
    ...
    public void OnFinnishTimer()
    {
        ...
        IEnumerator DelayPost()
        {
            AudioManager
                .GetManager()
                .GetAudioAndASR(transcriptGO, scoreButtonGO, taskType, taskNumber, isFinnish);
