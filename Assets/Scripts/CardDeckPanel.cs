...
{
    [SerializeField]
    GameObject deckListPrefab; // Refer to ListCardDeck prefab

    [SerializeField]
    GameObject content;

    [SerializeField]
    GameObject cardDeckPanelGO;

    [SerializeField]
    GameObject superMemoPanelGO;
    ...
    [SerializeField]
    List<GameObject> flashCardsGO = new List<GameObject>();

    [SerializeField]
    GameObject secretFlashCardGO; // Refer to SecretFlashCard
    ...
    public void LoadFlashCards()
    {
        ...
        foreach (GameObject flashCardGO in flashCardsGO)
        {
            ...
            int learnCards = flashCard.cards.Count(card =>
                card.cardType == (int)CARD_TYPE.LEARNING
                || card.cardType == (int)CARD_TYPE.RELEARNING
            );
            int dueCards = flashCard.cards.Count(card =>
            ...
            flashCardGO
                ...
                .GetComponent<Image>()
                .fillAmount = flashCard.progress / 100f;
            flashCardGO
                .transform.Find("ProgressPanel")
            ...
            flashCardGO
                .transform.Find("DeckPanel")
                .transform.Find("CardInfoText")
                .GetComponent<TMPro.TextMeshProUGUI>()
                .text = TextUtils.FormatCardTypeNumber(newCards, learnCards, dueCards);
