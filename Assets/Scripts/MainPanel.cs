...
public class MainPanel : MonoBehaviour
{
    ...
    [SerializeField]
    GameObject dropShadowBGO;

    [SerializeField]
    GameObject dropShadowRGO;

    [SerializeField]
    GameObject textInputPanelGO;
    ...
    [SerializeField]
    GameObject againButtonGO;

    [SerializeField]
    TMPro.TMP_InputField inputText;
    ...
    [SerializeField]
    GameObject waitIconGO;

    [SerializeField]
    GameObject recordButtonGO;

    [SerializeField]
    GameObject inputTransGO;
    ...
    [SerializeField]
    GameObject sampleButtonGO; // Play sample audio

    [SerializeField]
    GameObject detailButtonGO; // Display detail feedback
    ...
    public void SetUpStartUI()
    {
        ...
        textInputPanelGO.GetComponentInChildren<TMPro.TextMeshProUGUI>().text =
            "Did you find a new Finnish word or sentence?";
    ...
    private void ResetStopButtonAnimation()
    {
        ...
        stopButtonPanelGO.GetComponent<UnityEngine.UI.Image>().sprite = Resources.Load<Sprite>(
            "app_icons/ic_timer_0"
        );
    }
    ...
    private void OnServerDone()
    {
        ...
        if (replayClip != null)
        {
            ...
            detailButtonGO
                .GetComponent<Button>()
                .onClick.AddListener(() =>
                    detailScorePanel.ShowDetailScorePanel(
                        transcript,
                        null,
                        AudioManager.GetManager().GetReplayClip()
                    )
                );
        }
    }
