...
public static class Const
{
    ...
    */
    ...
    public const string PREF_INS_TOPIC = "pref_instruction_topic";
    ...
    public const string INSTRUCTION_MAIN = "Practice your pronunciation by typing any words or sentences in the box. The model doesn't work well with short words or spoken Finnish.\n" +
                                            ...
                                            "<b><color=#ffa500ff>Yellow</color></b>: almost correct, or there is an accent or dialect, or the AI model made a mistake.\n" +
    ...
    public const string INSTRUCTION_TOPIC = "<b>Topic</b> is an experimental mode for practising pronunciation with hand-picked samples. " +
                                            "The recommended topic is Pair which always has audio samples from a native speaker to practise Finnish vowels. " +
                                            "We will add more examples if there is demand for this mode.\n\n" +
                                            "We recommend using the <b>Vocabulary</b> mode to learn vocabulary instead of this mode.";
    public const string INSTRUCTION_VOCABULARY = "This mode has flashcards (similar to Anki) to help learn vocabulary. \n\n" +                                                
                                                 "Your task is translating between English and Finnish. " +
                                                 "And you can practice pronunciation and listening using the <b>recording button</b> " +
                                                 "and the audio generated by AI. \n\n" +
                                                 "For each card, you can rate the difficulty from Again to Easy. " +
                                                 "The easier you remember the card, the longer it will disappear. " +
                                                 "Each day your task is to learn 20 new words. You can long press on the deck to learn more.\n\n" +
                                                 "We will regularly update the flashcards. We also welcome volunteers to help translate " +
